...
"""
@Author  : pixelock
@File    : dataset_generate_lsvt.py
@Date    : 2022/10/26 0:17 
"""

import os
import argparse

from utils.data.manager import LSVTManager
from constant import PATH_DATA, PATH_DATA_DET, PATH_DATA_RECOG, PATH_DATA_RECOG_IMG

PATH_LSVT = os.path.join(PATH_DATA, 'ICDAR-2019-LSVT')
...
parser.add_argument('--det_name', default='lsvt.txt', type=str, help='file name of detection ground truth file')
parser.add_argument('--reg_dir', default=PATH_DATA_RECOG, type=str, help='path to save recognition ground truth files')
parser.add_argument('--reg_name', default='lsvt.txt', type=str, help='file name of recognition ground truth file')
...
if __name__ == '__main__':
    manager = LSVTManager(path=args.dataset_dir)
