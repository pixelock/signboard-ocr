...
parser.add_argument('--exclude_unrecog', action='store_true', help='whether exclude unrecognizable box in detection and recognition labels')
...
if __name__ == '__main__':
    manager = ShopSignManager(path=args.dataset_dir, exclude_unrecognizable=args.exclude_unrecog)
