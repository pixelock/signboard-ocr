...
python PaddleOCR/tools/eval.py -c configs/det/db++/eastcrop640-d1.yml  -o Global.checkpoints="output/det/db++/eastcrop640/d1/best_accuracy"
python PaddleOCR/tools/eval.py -c configs/det/db++/eastcrop640-d1.yml  -o Global.checkpoints="output/det/db++/eastcrop640/d1/best_accuracy" PostProcess.thresh=0.3 PostProcess.box_thresh=0.4 PostProcess.unclip_ratio=2.0
